                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                            ...
                            <div className="text-sm text-gray-700 space-y-2">
                                ...
                                <p><strong>Сколько стоит участие?</strong> Neutral Heart можно получить за {priceEth ? `${priceEth} MATIC` : '(загружается цена)'} . Вы платите только газ за транзакции (получение и трансформацию).</p>
                            </div>
                            ...
                            <div className="text-sm text-gray-700 space-y-2">
                                ...
                                <p><strong>Могу ли я выбрать позже?</strong> Да. Neutral Heart может оставаться в вашем кошельке сколько угодно. Но пока вы не сделаете выбор, NFT остаётся в нейтральном состоянии.</p>
