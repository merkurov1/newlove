  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Link
          href="/admin/letters"
          className="block bg-yellow-50 border border-yellow-200 rounded-lg p-4 hover:bg-yellow-100 transition"
        >
        ...
        <Link
          ...
          className="block bg-pink-50 border border-pink-200 rounded-lg p-4 hover:bg-pink-100 transition"
        >
      ...
      <div className="mt-6">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          <p className="text-sm text-gray-700 mb-3">
            Если вы опубликовали письмо и хотите сразу обновить публичную страницу архива, нажмите
            кнопку ниже.
          </p>
          <form
          ...
          <ul className="space-y-2">
            {recentArticles.map((a) => (
              <li key={a.id} className="flex items-center gap-2">
                ...
                {a.published ? (
                  <span className="ml-2 text-green-600 text-xs">● опубликовано</span>
                ) : (
                  <span className="ml-2 text-gray-400 text-xs">черновик</span>
                )}
