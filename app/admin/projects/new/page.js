...
export default function NewProjectPage() {
  return (
    <div>
      ...
      {/* Эта форма вызывает серверное действие createProject из файла /app/admin/actions.js */}
      <form action={createProject} className="space-y-6 bg-white p-8 rounded-lg shadow-md">
        <div>
          <label htmlFor="title" className="block text-sm font-medium text-gray-700">Название проекта</label>
