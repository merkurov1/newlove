...
export default function ArtEngineDashboard() {
  ...
  // REQUEST ACCESS HANDLER (Connected to Backend & Telegram)
    ...
    <div className="min-h-screen bg-[#FDFDFC] text-neutral-900 font-sans selection:bg-neutral-900 selection:text-white break-words">
      ...
      {showAuthModal && (
        <div className="fixed inset-0 z-50 bg-neutral-950/40 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white border border-neutral-200 max-w-md w-full p-6 sm:p-8 shadow-2xl space-y-6">
              ...
              requestSuccess ? (
                <div className="py-6 text-center space-y-4 font-mono">
                  ...
                  <p className="text-xs text-neutral-500 leading-relaxed max-w-xs mx-auto break-words">
                    Your institutional accreditation request for <span className="text-neutral-800 font-bold">{authEmail}</span> has been queued and sent for review.
                  </p>
                  <button
                    type="button"
      ...
      {/* Основной контейнер */}
      <div className="max-w-7xl mx-auto pt-28 sm:pt-32 pb-32 px-4 sm:px-6 lg:px-12 space-y-12 overflow-x-hidden">
        
        <header className="flex flex-col items-center justify-center text-center border-b border-neutral-200/80 pb-10 bg-white px-6 sm:px-8 py-12 border shadow-sm">
          <div className="space-y-3 max-w-2xl">
            <span className="text-xs font-mono tracking-[0.2em] sm:tracking-[0.3em] uppercase text-neutral-400 font-semibold block px-2">
              Institutional Art Advisory & Market Intelligence
            </span>
            <h1 className="text-3xl sm:text-5xl font-serif text-neutral-900 tracking-tight font-normal break-words">
              Art Intelligence Terminal
            </h1>
          </div>

          {user && (
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3 bg-neutral-50 border border-neutral-200 px-4 py-2 text-xs font-mono max-w-full">
        ...
        {!loadingUser && !user ? (
          <div className="py-20 sm:py-36 max-w-4xl mx-auto text-center space-y-8 sm:space-y-12 bg-white border border-neutral-200/80 p-6 sm:p-24 shadow-sm">
            <div className="space-y-4">
              <h2 className="text-2xl sm:text-4xl font-serif text-neutral-900 leading-tight">
                Fine Art Banking & Advisory Infrastructure
              </h2>
              
              <p className="text-sm sm:text-lg font-serif text-neutral-600 leading-relaxed font-light max-w-2xl mx-auto pt-2">
            ...
            <div className="pt-2 flex flex-col sm:flex-row justify-center gap-4 sm:gap-5 font-mono">
              <button
                onClick={() => { setAuthMode('signin'); setShowAuthModal(true); }}
                className="bg-neutral-900 hover:bg-black text-white text-xs uppercase tracking-widest px-8 sm:px-10 py-4 transition shadow-sm font-bold"
              >
                Sign In
              </button>
              <button
                onClick={() => { setAuthMode('request'); setShowAuthModal(true); }}
                className="bg-white hover:bg-neutral-50 text-neutral-900 border border-neutral-300 text-xs uppercase tracking-widest px-8 sm:px-10 py-4 transition font-bold"
              >
                Request Access
              </button>
            </div>
          ...
          <>
            <nav className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-neutral-200/80 pb-4 bg-white px-6 sm:px-8 pt-4 gap-4 border shadow-sm">
              <div className="flex gap-6 sm:gap-8 overflow-x-auto w-full sm:w-auto pb-2 sm:pb-0">
                <button
                  onClick={() => setActiveTab('parser')}
                  className={`font-mono text-xs uppercase tracking-widest transition pb-2 whitespace-nowrap relative ${
                    activeTab === 'parser' 
              ...
              {activeTab === 'parser' && (
                <div className="flex items-center gap-4 w-full sm:w-auto justify-between sm:justify-end">
                  <span className="text-[11px] font-mono text-neutral-500 bg-neutral-50 border border-neutral-200 px-3 py-1 truncate max-w-[200px] sm:max-w-none">Status: {statusText}</span>
                  <button 
                    onClick={handleReset}
                    className="text-xs font-mono text-neutral-400 hover:text-neutral-900 transition uppercase tracking-wider shrink-0"
                  >
                    Reset
                  </button>
                </div>
                  ...
                  <div className="bg-white border border-neutral-200/80 p-6 space-y-4 shadow-sm">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      <input 
                        ...
                        className="flex-1 bg-neutral-50 border border-neutral-300 px-3.5 py-2.5 text-xs text-neutral-900 focus:outline-none focus:border-neutral-900 transition font-mono placeholder:text-neutral-400 break-all"
                        value={input.link}
                ...
                <div className="lg:col-span-7">
                  {loading ? (
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-white border border-neutral-200/80 p-4 gap-3 shadow-sm">
                      ...
                      {showRawJson ? (
                        <div className="border border-neutral-200/80 p-6 bg-white shadow-sm">
                          <pre className="text-neutral-800 font-mono text-xs whitespace-pre-wrap overflow-x-auto max-h-[600px] break-all">
                            {JSON.stringify(output, null, 2)}
                          </pre>
                        </div>
                      ) : (
                        <div className="bg-white border border-neutral-200/80 p-6 sm:p-10 space-y-8 max-h-[750px] overflow-y-auto shadow-sm">
                          ...
                          <div className="border-b border-neutral-200 pb-6 space-y-3">
                            <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                              <div>
                                ...
                                <h2 className="text-2xl sm:text-3xl font-serif text-neutral-900 mt-2 font-normal break-words">
                              ...
                              {output.estimate_raw && (
                                <div className="text-left sm:text-right bg-neutral-50 p-3 border border-neutral-200 w-full sm:w-auto">
                            ...
                            <div className="pt-4">
                              <h3 className="text-lg sm:text-xl font-serif italic text-neutral-800 break-words">
                                {output.title || input.title} {output.year && <span className="not-italic text-neutral-400 text-sm">({output.year})</span>}
                              </h3>
                              {output.medium && <p className="text-xs text-neutral-600 mt-2 font-mono break-words">{output.medium}</p>}
                          ...
                          {output.curatorial_essay && (
                            <div className="space-y-3">
                              ...
                              <div className="text-neutral-800 text-sm font-serif leading-relaxed whitespace-pre-line break-words">
                                {output.curatorial_essay}
                              </div>
                            </div>
                          )}
                        ...
                        >
                          ...
                          <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                            <div>
                              ...
                              <h2 className="text-lg font-serif text-neutral-900 group-hover:underline break-words">{lot.artist}</h2>
