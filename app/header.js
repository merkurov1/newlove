Отлично, вот полный и исправленный код для файла header.js, который включает в себя:
 * Отображение логотипа.
 * Название сайта и слоган.
 * Динамическое меню.
 * Функциональность переключения между светлой и тёмной темой.
Этот компонент является Client Component, поэтому он использует хуки useState и useEffect для управления состоянием темы. Данные для меню, названия сайта и слогана передаются в него из Server Component (page.js) в качестве пропсов.
'use client';
