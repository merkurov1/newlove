...
const ASSETS = {
  ...
  AUDIO:
    'https://txvkqcitalfbjytmnawq.supabase.co/storage/v1/object/public/media/Artist_Analyst_Anton_Merkurov__Unframing_the_Granite.m4a',
};
...
const TimelineSection = ({ item }: any) => {
  ...
  return (
    <section
      ref={ref}
      className="min-h-screen flex items-center justify-center relative py-24 border-t border-zinc-900 bg-[#050505]"
    >
...
export default function UnframedPage() {
  ...
  return (
    <div
      className={`bg-[#050505] text-white selection:bg-red-600 selection:text-white font-sans overflow-x-hidden ${sans.variable} ${mono.variable} ${serif.variable}`}
    >
      {/* GLOBAL GRAIN */}
      <div
        ...
        <div className="max-w-4xl text-center">
          <p className="text-3xl md:text-5xl font-serif text-zinc-100 leading-tight">
            ...
            <span className="text-zinc-500 text-2xl md:text-4xl block my-12 leading-normal">
              <Redacted>The System</Redacted> demanded <Redacted>noise</Redacted>.<br />I gave it{' '}
              <Redacted>noise</Redacted>.
            </span>
            But the granite eventually cracks. UNFRAMED is the story of closing the loop. Of
            returning to the only thing that matters: The Line."
          </p>
      ...
      <div className="relative z-20 bg-[#050505] border-t border-zinc-900 pb-20">
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-zinc-400 font-serif text-lg mb-10 leading-relaxed border-l border-zinc-800 pl-6">
                "Two synthetic intelligences deconstruct the manuscript, analyzing the shift from
                the heavy Granite of the Soviet past to the weightless Ether of the digital
                present."
              </p>
              <div className="bg-zinc-900/50 border border-zinc-800 p-6">
                <audio
                  controls
                  className="w-full invert opacity-60 hover:opacity-100 transition-opacity"
                >
        ...
        <section className="px-6 flex justify-center pb-20">
          <div className="max-w-xl w-full border border-zinc-800 p-10 bg-black shadow-2xl">
            ...
            <h2 className="text-4xl font-black uppercase mb-2 tracking-tighter text-white font-sans">
              Request Proposal
            </h2>
